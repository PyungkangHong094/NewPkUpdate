export const projects = [
  {
    id: '1',
    type: 'web',
    title: '3TP Trading Strategy',
    description:
      'Advanced trading strategy development and automation platform using Pine Script',
    ...
    details: {
      ...
      team: 'Solo Project',
      stack: ['Pine Script', 'Python', 'TradingView API'],
      features: [
    ...
    links: {
      Link: 'https://www.notion.so/chartget-3tp/ChartGet-Algo-3TP-e0542a5001a944eba22118fcdc90c12b',
      description:
  ...
  },
  {
    id: '2',
    type: 'web',
    title: 'Metro Health Insurance',
    description:
      'Insurance company platform with integrated admin system and digital marketing tools',
    imageUrl:
  ...
  },
  {
    ...
    title: 'ChartQ',
    description:
      'ChartQ is a comprehensive platform for mastering financial chart analysis, combining education, quizzes, games, and practical trading strategies to help users succeed in real-world investing',
    imageUrl:
    ...
    details: {
      period: 'May 2024 - Present [Working On]',
      team: [
        'PM - Pyungkang Hong',
        'Backend Developer - Jaehun Kim',
        'Frontend Developer - whwa-seokLee',
        'UI&UX Desginer - Hyemin Choi',
      ],
      stack: [
        'Flutter',
        'Supabase',
      ...
      features: [
        'Interactive OX quizzes and tests',
  ...
  },
  {
    ...
    title: 'Fidesbankcard',
    description:
      'Integrated company platform with POS inventory management and digital marketing solutions',
    imageUrl:
    ...
    details: {
      ...
      team: [
        'Project Manager - Pyungkang Hong',
        'Backend Developer - David Kim',
        'UI/UX Designer - Roy Choi',
      ],
  ...
  },
  {
    ...
    title: 'Mocean',
    description:
      'Multi-functional healthcare platform with doctor admin panel and appointment booking system',
    imageUrl:
    ...
    details: {
      ...
      team: [
        'Project Lead - Pyungkang Hong',
        'Backend Developer - Hawon Park',
        'Frontend Developer - Jaehun Kim',
      ],
      stack: ['React', 'Pythong', 'Django', 'nginx', 'Docker', 'RESTFul api'],
      features: [
    ...
    links: {
      ...
      description:
        'Mocean transforms healthcare management with its comprehensive platform designed for both medical professionals and patients. The system streamlines appointment scheduling, patient record management, and administrative tasks, while providing powerful analytics tools for healthcare providers. Its intuitive interface and automated features significantly improve operational efficiency in healthcare practices.',
    },
  },
  {
    id: '6',
    ...
    title: 'FD Holdings',
    description:
      'Modern company landing page with professional design and enhanced brand visibility',
    imageUrl:
    ...
    details: {
      ...
      team: [
        'Lead Developer - Pyungkang Hong',
        'Back- end - Hawon Park',
        'UI/UX Designer - Young Jin Lee',
      ],
    ...
    links: {
      ...
      Other_Branch: 'https://fdblockchain.co.kr/',
      Other_Branch_2: 'https://www.fdgenuine.com/',
      description:
        'FD Holdings manages multiple branches, and my work focused on the blockchain division, entertainment section, and the main homepage landing page. I developed a responsive layout and designed an integrated user management system along with a CRM program. Additionally, I created a unified CRM admin page that consolidates the operations of six different business branches into one centralized platform',
    },
  },
  {
    id: '7',
    ...
    title: 'Featuring Co',
    description:
      'SEO-optimized blogging platform with comprehensive user data analysis',
    imageUrl:
    ...
    details: {
      ...
      team: ['Front-end & SEO Specialist - Pyungkang Hong'],
    ...
    links: {
      ...
      description:
        'Featuring Co leverages advanced analytics to track user behavior and provides valuable insights for content creators while integrating AI technology to highlight user interests. The platform includes a dedicated blog section and incorporates SEO strategies to enhance visibility. By curating content that resonates with users preferences, it effectively captures their attention and fosters engagement',
    },
  },
  {
    id: '8',
    ...
    title: 'ChartGet',
    description:
      'Chartget is a cross-platform app designed for learning and mastering chart analysis, offering curated study lists, interactive examples, personalized saving options, and powerful tools to enhance users charting skills',
    imageUrl:
    ...
    details: {
      ...
      team: [
        'PM - Pyungkang Hong',
        'Backend Developer - Jaehun Kim',
        'Frontend Developer - YoungJin Lee',
      ],
      stack: ['Flutter', 'Firebase', 'Dart', 'Firebase Storage', 'Hive/SQLite'],
      features: [
        'Chart study lists with topic-based filtering',
        'Interactive learning examples',
        'Personalized content saving',
    ...
    links: {
      ...
      description:
        'ChartGet revolutionizes chart analysis education with its innovative mobile platform. The app combines comprehensive learning resources with interactive tools, allowing users to study and practice chart analysis in a structured environment. With features like personalized content saving and progress tracking, users can efficiently build their skills while maintaining engagement through the learning process.',
    },
  },
  {
    id: '9',
    ...
    title: 'Woulduin Coin',
    description:
      'Web and mobile platform for coin prices, chats, blogs, news, and Korean exchange chart listings',
    imageUrl:
    ...
    details: {
      period: 'Jan 2021 - Dec 2021 [Product Sold]',
      team: [
        'PM - Pyungkang Hong',
        'Backend Developer - Hawon Park',
        'Frontend Developer - YoungJin Lee',
      ...
      features: [
        ...
        'Chat feature for user discussions',
        'Blog and news section',
        'Korean exchange chart listings',
        'Dark mode and customizable UI',
      ],
    },
    links: {
      playStore:
        'https://appadvice.com/app/ec-9a-b0-ec-a3-bc-ec-9d-b8-ec-bd-94-ec-9d-b8/1577729016',
      description:
        'Woulduin Coin provides a comprehensive cryptocurrency information platform tailored for the Korean market. The app combines real-time price tracking, community features, and news aggregation to create a one-stop solution for crypto enthusiasts. With its intuitive interface and robust feature set, users can stay informed about market movements while engaging with the crypto community.',
    },
  },
] as const;
